...
package { 'bind9-host':
  ensure => '1:9.10.3.dfsg.P4-8ubuntu1.14',
}
package { 'binutils':
...
package { 'cloud-init':
  ensure => '19.1-1-gbaa47854-0ubuntu1~16.04.1',
}
...
package { 'curl':
  ensure => '7.47.0-1ubuntu2.13',
}
package { 'dash':
  ensure => '0.5.8-2.1ubuntu2',
}
package { 'dbus':
  ensure => '1.10.6-1ubuntu3.4',
}
package { 'debconf':
  ensure => '1.5.58ubuntu2',
}
...
package { 'grub-common':
  ensure => '2.02~beta2-36ubuntu3.22',
}
...
package { 'liblxc1':
  ensure => '2.0.11-0ubuntu1~16.04.3',
}
package { 'liblz4-1':
...
package { 'linux-aws':
  ensure => '4.4.0.1085.88',
}
package { 'linux-aws-headers-4.4.0-1085':
  ensure => '4.4.0-1085.96',
}
package { 'linux-base':
  ensure => '4.5ubuntu1~16.04.1',
}
package { 'linux-headers-4.4.0-1085-aws':
  ensure => '4.4.0-1085.96',
}
package { 'linux-headers-aws':
  ensure => '4.4.0.1085.88',
}
package { 'linux-image-4.4.0-1085-aws':
  ensure => '4.4.0-1085.96',
}
...
package { 'linux-libc-dev':
  ensure => '4.4.0-151.178',
}
package { 'linux-modules-4.4.0-1085-aws':
  ensure => '4.4.0-1085.96',
}
package { 'locale':
  ensure => ['2.1.2'],
...
package { 'ntfs-3g':
  ensure => '1:2015.3.14AR.1-1ubuntu0.3',
}
package { 'ntp':
...
package { 'python-apt-common':
  ensure => '1.1.0~beta1ubuntu0.16.04.5',
}
...
package { 'python3-urllib3':
  ensure => '1.13.1-2ubuntu0.16.04.3',
}
